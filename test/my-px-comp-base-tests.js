...
function runBaseTests() {
  my_px_comp_1 = document.getElementById('my_px_comp_1');

  suite('Base Automation Tests for my-px-comp', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('my-px-comp fixture is created', function() {
      assert.isTrue(document.getElementById('my_px_comp_1') !== null);
    });
